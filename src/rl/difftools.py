...
from torchdiffeq._impl.misc import (Perturb, _check_inputs, _flat_to_shape,
...
class EulerSolver(metaclass=abc.ABCMeta):
    ...
    def __init__(
        self, func, y0, step_size=None, grid_constructor=None,
        interp="linear", perturb=False, **unused_kwargs
    ):
